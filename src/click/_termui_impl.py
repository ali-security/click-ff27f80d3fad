...
def _pipepager(
    ...
    # Multi-call binaries such as busybox derive their identity from the
    # symlink name (less -> busybox), so don't resolve symlinks here.
    cmd_name = os.path.basename(cmd_absolute)
